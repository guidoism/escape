...
- [Omar Rizwan](https://rsnous.com) - Has several interesting projects that show how computing can be, also has [Dewdrop](http://dev.rsnous.com/dewdrop/executive/) is a work-in-progress reimplementation of Sun's NeWS (Network/extensible Window System) version 1.1. Nice!
